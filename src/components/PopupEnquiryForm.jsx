    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          exit={{ y: -50, opacity: 0 }}
          transition={{ duration: 0.3, ease: "easeInOut" }}
          className="relative w-full max-w-md p-6 bg-white shadow-xl rounded-lg border border-gray-200"
        >
          <button
            onClick={onClose}
            className="absolute top-3 right-3 text-gray-500 hover:text-gray-800 transition-all transform hover:scale-110"
          >
            <X size={24} />
          </button>
          ...
          {!responseMessage ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3 text-white text-lg font-medium rounded-lg bg-orange-600 hover:bg-orange-700 transition-all"
                >
                  Submit Enquiry
                </button>
              </form>
